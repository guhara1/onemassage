    ...
    <>
      ...
      <Section className="pt-8">
        <div className="mx-auto mb-10 max-w-3xl space-y-4 text-base leading-relaxed text-forest-700">
          ...
          <p>
            현재 안내 중인 지역은 강남·수원·인천·용인·부산·성남입니다. 강남·성남은 직장인과
            출장객의 야간 피로 관리 문의가 많고, 수원·용인은 대단지 신도시를 중심으로 가족 단위
            문의가 고르게 많으며, 인천·부산은 업무·관광 생활권과 출장객 수요가 어우러진 지역입니다.
            각 지역 카드를 눌러 해당 생활권의 세부 안내를 확인하실 수 있습니다.
          </p>
        </div>
