    ...
    <>
      ...
      <Section className="pt-8">
        <div className="mx-auto mb-10 max-w-3xl space-y-4 text-base leading-relaxed text-forest-700">
          ...
          <p>
            현재 안내 중인 지역은 강남·송파·마포입니다. 강남은 직장인과 출장객의 야간 피로 관리
            문의가 많고, 송파는 대단지 아파트를 중심으로 가족 단위와 직장인 문의가 고르게 많으며,
            마포는 상암 업무지구와 홍대·합정·공덕 생활권을 중심으로 1인 가구와 야근이 잦은 직장인의
            문의가 많습니다. 각 지역 카드를 눌러 해당 생활권의 세부 안내를 확인하실 수 있습니다.
          </p>
        </div>
