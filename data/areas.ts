...
export const areas: Area[] = [
  {
    ...
    metaDescription:
      "강남역·역삼·선릉·삼성 일대로 방문하는 예약제 웰니스 출장마사지. 야근·출장 후 피로 관리에 맞춘 가능 시간, 출장비, 오피스텔 방문 절차를 투명하게 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "잠실·가락·문정·방이 대단지 아파트와 업무지구로 방문하는 송파 예약제 출장마사지. 가족·직장인을 위한 가능 구역, 출장비, 아파트 방문 유의사항을 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "홍대·상암·합정·공덕 일대로 방문하는 마포 예약제 출장마사지. 미디어·IT 종사자와 1인 가구의 야간 피로·주말 휴식에 맞춘 가능 시간과 방문 절차를 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "광교·영통 신도시와 인계동 번화가로 방문하는 수원 예약제 출장마사지. 가족·서울 통근 직장인을 위한 가능 구역, 출장비, 아파트 방문 유의사항을 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "송도·청라 신도시와 부평·구월동, 인천공항 인근 숙소까지 방문하는 인천 예약제 출장마사지. 가능 구역, 출장비, 숙소·아파트 방문 절차를 투명하게 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "수지·죽전·기흥 대규모 주거단지로 방문하는 용인 예약제 출장마사지. 가족과 장거리 통근 직장인을 위한 가능 구역, 출장비, 아파트 방문 유의사항을 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "해운대·광안리 관광 숙소와 서면·센텀시티 업무지구로 방문하는 부산 예약제 출장마사지. 호텔·숙소 방문 절차와 가능 시간, 출장비를 투명하게 안내합니다.",
  ...
  },
  {
    ...
    metaDescription:
      "분당·판교·정자·서현 일대로 방문하는 성남 예약제 출장마사지. 판교 IT 종사자의 야근 피로와 분당 가족 케어에 맞춘 가능 시간, 출장비, 방문 절차를 안내합니다.",
